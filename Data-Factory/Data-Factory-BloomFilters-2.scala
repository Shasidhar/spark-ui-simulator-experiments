...
// MAGIC %sql
// MAGIC 
// MAGIC DROP table IF EXISTS bloomfilters_v2;
// MAGIC -- 24B rows
...
// MAGIC  USING delta 
// MAGIC  LOCATION '/mnt/dbacademy/spark-ui-simulator-rw/global-sales/transactions/2011-to-2018-1tb-bloom_trx_2.delta/'
